...
#### Create subset of countries from previous subset with population greater than 100 million
```{r}
...
![Urbanization vs Emissions in Color of highly populated(https://github.com/MBWitz/DataSurfers/blob/master/Plots/Rplot_co2_vs_urban_all_countries.PNG)

#### create a subset of countries from previous subset with population less than 10 million
```{r}
