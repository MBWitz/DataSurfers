...
This plot shows that highly populated countries vary differently based on there urbanization level such as highly urbanized countries (>50%) such as Korea, Russia, Germany have a steady decrease in CO2 emissions when compared less urbanized countries (<50%) such as China and India. 
...
![NOX and SOX emissions OED vs Urbanization](https://github.com/MBWitz/DataSurfers/blob/master/Plots/OECD_Plot_1_new.png)
...
![NOX and SOX emissions non OED vs Urbanization](https://github.com/MBWitz/DataSurfers/blob/master/Plots/nonOECD_plot2_new.png)
