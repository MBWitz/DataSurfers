...
#### Load data:
```{r}
ghg <- read.csv("https://raw.githubusercontent.com/MBWitz/DataSurfers/master/air_ghg_data_w_regions_new.csv")
```
...
```  
https://github.com/MBWitz/DataSurfers/blob/master/Deliverables/R%20Script/Total_CO2_Top7.png
...
https://github.com/MBWitz/DataSurfers/blob/master/Deliverables/R%20Script/CO2_Emissions_PC_Top7.png
...
```  
https://github.com/MBWitz/DataSurfers/blob/master/Deliverables/R%20Script/CO2_Emissions_Region.png
...
ggplot(data = ghg.region, aes(x = TIME, y = CO2percap, group = Region)) +
     ...
     geom_line(aes(color = Region))
```  
https://github.com/MBWitz/DataSurfers/blob/master/Deliverables/R%20Script/CO2_Emissions_PC_Region.png
...
```
https://github.com/MBWitz/DataSurfers/blob/master/Deliverables/R%20Script/CO2_Value_vs_Urban.png
...
```
https://github.com/MBWitz/DataSurfers/blob/master/Deliverables/R%20Script/CO2_Value_vs_Urban_NoUSA_CHN.png
...
```
https://github.com/MBWitz/DataSurfers/blob/master/Deliverables/R%20Script/CO2_Value_vs_Urban_Best_Fit.png
...
ggtitle("Total CO2 Emissions vs. Urbanization", subtitle="All Countries") +
 geom_line(aes(color = COUNTRY))
```
https://github.com/MBWitz/DataSurfers/blob/master/Deliverables/R%20Script/CO2_Value_vs_Urban_Color.png
...
ggtitle("Total CO2 Emissions vs Urbanization", subtitle="Without China and USA") +
 geom_line(aes(color = COUNTRY))
```
https://github.com/MBWitz/DataSurfers/blob/master/Deliverables/R%20Script/CO2_Value_vs_Urban_Color_NoUSA_CHN.png
...
```
https://github.com/MBWitz/DataSurfers/blob/master/Deliverables/R%20Script/NOX_SOX_OED_vs_Not.png
